export const translations = {
  tr: {
    ...
    hero: {
      ...
      description: 'Sıfır ve İkinci El Seçeneklerimizde <br class="sm:hidden" /> İhtiyacınız Olan Her Ebatta, <br class="sm:hidden" /> Yüksek Kondisyonda Konteyner Çözümleri <br class="sm:hidden" /> Küresel ve Yerel Operasyonlarınızın Güvencesiyiz.',
