...
export default function Header({ locale = 'tr' }: { locale?: string }) {
  ...
  const navLinks = [
    ...
    { href: `/${locale}/hizmetlerimiz`, label: 'Hizmetlerimiz' },
    { href: `/${locale}/konteynerlar`, label: 'Konteynerlar' },
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <button className="px-3 py-1 text-sm font-medium text-white bg-secondary-500 rounded">
                TR
              </button>
              <button className="px-3 py-1 text-sm font-medium text-secondary-500 hover:bg-secondary-500 hover:text-white rounded transition-colors">
                EN
              </button>
            </div>
          </div>
